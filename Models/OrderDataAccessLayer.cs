...
namespace KanbanWithCrudCustomAdaptor.Models
{
    public class OrderDataAccessLayer
    {
       ...
       // To Add new Order record
        ...
        public void DeleteOrder(OrderDetail data)
        {
            try
            {
                db.OrderDetails.Remove(db.OrderDetails.Where(or => or.EmployeeId == data.EmployeeId).FirstOrDefault());
                db.SaveChanges();
            }
            catch
            {
